...
G_EXEC curl -sSfL https://stackpath.bootstrapcdn.com/bootstrap/4.5.3/css/bootstrap.min.css -o css/bootstrap.min.css
...
G_EXEC curl -sSfL https://stackpath.bootstrapcdn.com/bootstrap/4.5.3/js/bootstrap.min.js -o js/bootstrap.min.js
